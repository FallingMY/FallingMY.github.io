(() => {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\snackbar\index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\actions-panel\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\app\index.ts
  var App = class {
    constructor() {
  ...
  // ns-params:@params
  var giscus = { category: "Announcements", categoryid: "DIC_kwDOMR9LT84CglZS", repo: "FallingMY/FallingMY.github.io", repoid: "R_kgDOMR9LTw" };
  var params_default = { analytics: null, archive: { paginate: 20 }, baseURL: "http://localhost:1313/", brand: "Falling_MY", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false }, color: "auto", contact: null, counttaxonomyposts: true, creativecommons: null, customcss: null, customjs: null, dateformat: ":date_long", description: "An extreme fast, responsive and feature-rich blog theme for Hugo", diagram: false, featuredpostcount: false, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Hugo, Bootstrap, Blog Theme", logo: "images/icon.png", mainsections: ["blog", "posts", "news"], palette: "blue-gray", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "HBS" } }, readingtime: true, recentpostcount: false, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/FallingMY/FallingMY.github.io" }, reward: { alipay: "images/reward/alipay.png", wechat: "images/reward/wechat.png" }, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: { archives: false, featuredposts: false, recentposts: false }, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { bilibili: "yourbilibiliuserid", bitbucket: "yourbitbucketworkspaceid", discord: false, discourse: false, dockerhub: "yourdockerhubusername", email: "user@domain.tld", facebook: "yourfacebookusername", facebookgroup: false, github: "razonyang/hugo-theme-bootstrap", gitlab: "yourgitlabusername", instagram: "yourinstagramusername", kaggle: false, lastfm: false, liberapay: false, linkedin: "yourlinkedinusername", mastodon: false, medium: false, patreon: false, paypal: false, pinterest: false, qq: "yourqqnumber", quora: "yourquorausername", reddit: "yourredditusername", stackoverflow: "yourstackoverflowuserid", telegram: "yourtelegramusername", tiktok: false, tipeee: false, tumblr: "yourtumblrusername", twitter: "yourtwitterusername", weibo: "yourweibousername", xing: "yourxingusername", youtube: false, zhihu: "yourzhihuusername" }, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { github: "FallingMY/FallingMY.github.io", patreon: false, paypal: false } }, viewer: true };

  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\code\code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\code\index.ts
  var Code = class {
    run() {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\docs\catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\docs\index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\local-storage\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\font-size-selector\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\form-validator\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\iframe\index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\loading-bar\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\scroller\index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\sidebar-toggle\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\table-wrapper\index.ts
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\toc\index.ts
  var TOC = class {
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\main\js\components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\slide\index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\search\index.ts
  (() => {
    "use strict";
    var _a, _b;
  ...
  // ns-hugo:D:\Git\myblog\themes\hugo-theme-bootstrap\assets\js\mode\index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
