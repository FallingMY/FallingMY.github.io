(() => {
  ...
  var params_default = { analytics: null, archive: { paginate: 20 }, baseURL: "http://localhost:1313/", brand: "Falling_MY", breadcrumb: false, carouselpostcount: 5, codeblock: { linenos: true, maxlines: 64 }, color: "auto", contact: null, counttaxonomyposts: true, creativecommons: null, customcss: null, customjs: null, dateformat: ":date_long", description: "An extreme fast, responsive and feature-rich blog theme for Hugo", diagram: false, featuredpostcount: false, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Hugo, Bootstrap, Blog Theme", logo: "images/icon.png", mainsections: ["blog", "posts", "news"], math: true, palette: "blue-gray", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: false, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "FSO" } }, readingtime: true, recentpostcount: false, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/FallingMY/FallingMY.github.io" }, reward: { alipay: "images/reward/alipay.png" }, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: { archives: false, featuredposts: false, recentposts: false }, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { bilibili: "327274480", email: "falling_my@outlook.com", github: "FallingMY/FallingMY.github.io", qq: 1317096804, twitter: "FallingMY3" }, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { github: "FallingMY/FallingMY.github.io" } }, viewer: true };
