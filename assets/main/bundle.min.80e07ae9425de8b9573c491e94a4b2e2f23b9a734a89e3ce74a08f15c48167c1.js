(() => {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/snackbar/index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/actions-panel/index.ts
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/app/index.ts
  var App = class {
    constructor() {
  ...
  // ns-params:@params
  var giscus = { category: "Announcements", categoryid: "DIC_kwDOMSZCT84Cgl_T", repo: "FallingMY/FallingMY.github.io", repoid: "R_kgDOMR9LTw" };
  var params_default = { analytics: null, archive: { paginate: 20 }, author: { avatar: "images/avatar.jpg", bio: "Graphic Designer, Coder, Video Maker, Furry Lover", company: "Falling_Studio", location: "N/A", name: "Falling_MY", params: {}, social: { email: "faling_my@outlook.com", github: "fallingmy/fallingmy.github.io", twitter: "Falling_Studio_" } }, baseURL: "http://localhost:1313/", brand: "Falling_MY", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: true, maxlines: 64 }, color: "auto", contact: null, counttaxonomyposts: true, creativecommons: null, customcss: null, customjs: null, dateformat: ":date_long", description: "An extreme fast, responsive and feature-rich blog theme for Hugo", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: false, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Hugo, Bootstrap, Blog Theme", logo: "images/icon.png", mainsections: ["blog", "posts", "news"], math: true, palette: "blue-gray", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: false, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { icons: [{ sizes: "96x96" }, { src: "/images/icons/icon-96x96.png" }], short_name: "FSO" } }, readingtime: true, recentpostcount: false, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/FallingMY/FallingMY.github.io" }, reward: { alipay: "images/reward/alipay.jpg", wechat: "images/reward/wechat.jpg" }, sass_transpiler: "libsass", search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: { archives: false, featuredposts: false, recentposts: false }, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { bilibili: "327274480", email: "falling_my@outlook.com", github: "FallingMY/FallingMY.github.io", qq: 1317096804, twitter: "Falling_Studio_" }, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { github: "FallingMY/FallingMY.github.io" } }, viewer: true };

  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/code/code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/code/index.ts
  var Code = class {
    run() {
      document.addEventListener("DOMContentLoaded", () => {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/docs/catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/docs/index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/font-size-selector/index.ts
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/form-validator/index.ts
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/iframe/index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/loading-bar/index.ts
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/scroller/index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/sidebar-toggle/index.ts
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/table-wrapper/index.ts
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/toc/index.ts
  var TOC = class {
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/main/js/components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/slide/index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/search/index.ts
  (() => {
    "use strict";
    var _a, _b;
  ...
  // ns-hugo:/Users/Zhuanz/Code/git/myblog/themes/hugo-theme-bootstrap/assets/js/mode/index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
